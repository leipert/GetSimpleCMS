...
$i18n = array(
  ...
  , 'ADD_COMPONENT' => "<em>A</em>dd Component"
  ...
  , 'REQS_MORE_INFO' => "For more information on the required modules, visit the <a href=\"%s\" target=\"_blank\" >requirements page</a>."
  , 'SYSTEM_UPDATE' => "System Update"
  , 'AUTHOR' => "Author"
  , 'ENABLE' => "Activate"
  , 'DISABLE' => "Deactivate"
  , 'NO_THEME_SCREENSHOT' => "Your theme does not have a screenshot preview"
  ...
  , 'FOLDER_CREATED' => "The new folder was successfully created: <b>%s</b>"
  ...
  , 'STATUS' => "Status"
  , 'CLONE' => "Clone"
  , 'CLONE_SUCCESS' => "Successfully created %s"
  , 'COPY' => "Copy"
  , 'CLONE_ERROR' => "There was a problem trying to clone <b>%s</b>"
  , 'AUTOSAVE_NOTIFY' => "Page autosaved at"
  ...
  , 'NORMAL' => "Normal"
  , 'ERR_CANNOT_DELETE' => "Cannot delete %s. Please do this manually."
  , 'ADDITIONAL_ACTIONS' => "Other Actions"
  , 'ITEMS' => "items"
  , 'SAVE_MENU_ORDER' => "Save Menu Order"
  , 'MENU_MANAGER_DESC' => "Drag-and-drop the menu items around until you have the order you want, then click the <strong>'Save Menu Order'</strong> button."
  , 'MENU_MANAGER_SUCCESS' => "The new menu order has been saved"
